...
export function DonateBadgeShowcase() {
  return (
    <div className='mt-10 flex flex-col items-center gap-y-4 rounded-lg border bg-transparent p-6 text-center shadow-[0_0_50px_-12px] ring-1 shadow-[#4cc9f0]/30 ring-foreground/10'>
