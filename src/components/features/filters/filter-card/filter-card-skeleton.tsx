  ...
  return (
    <Card className='flex h-full max-w-(--breakpoint-sm) flex-col'>
      ...
      <CardContent className='pb-0'>
        <div className='overflow-hidden'>
          <div className='-ml-4 flex py-0.5'>
            {[...Array(6)].map((_, i) => (
              <div
                className='min-w-0 shrink-0 grow-0 basis-1/3 pr-px pl-[calc(--spacing(4)+1px)] min-[360px]:basis-1/4 min-[440px]:basis-1/5 min-[550px]:basis-1/6'
                key={i}
              >
                <Card className='p-1'>
      ...
      <CardFooter className='flex-col gap-3 sm:flex-row sm:justify-between lg:flex-col xl:flex-row'>
        ...
        <div className='flex w-full items-end gap-2 sm:w-auto lg:w-full xl:w-auto'>
