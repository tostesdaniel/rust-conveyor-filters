...
export function SharedFiltersEmptyState() {
  return (
    <div className='mt-6 text-center'>
      ...
      <p className='text-muted-foreground mx-auto mt-1 max-w-lg text-sm text-balance'>
      ...
      <ol className='text-muted-foreground mx-auto my-6 flex max-w-sm list-inside list-decimal flex-col items-start gap-y-2 text-sm'>
