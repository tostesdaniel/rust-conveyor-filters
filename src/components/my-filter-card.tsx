...
export function MyFilterCard({
  ...
  return (
    <li className='col-span-1 flex min-w-[300px] rounded-md shadow-xs'>
      <div className='border-foreground/70 bg-card text-card-foreground flex w-16 shrink-0 items-center justify-center rounded-l-md border-2 p-1.5 text-sm font-medium'>
        <Image
      ...
      <div className='border-card-foreground/70 flex flex-1 items-center justify-between rounded-r-md border-2 border-l-0'>
        <div className='flex-1 px-4 py-2 text-sm'>
          {isFilterShared ? (
            <p className='text-foreground/85 hover:text-foreground font-medium transition-colors'>
              {filter.name}
            </p>
          ) : (
            <Link
